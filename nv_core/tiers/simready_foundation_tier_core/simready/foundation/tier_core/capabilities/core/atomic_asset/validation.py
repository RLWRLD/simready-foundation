...
from ..path_utils import (
    is_udim_asset_path,
    resolve_existing_udim_template_path,
)
...
class AnchoredAssetPathsChecker(BaseRuleChecker):
    ...
    def _resolve_path(self, asset_path: str, anchor_path: str | Ar.ResolvedPath) -> str:
        ...
        if is_udim_asset_path(asset_path):
            return resolve_existing_udim_template_path(
                authored_path=asset_path,
                anchor_file_path=anchor_path.GetPathString(),
            )
