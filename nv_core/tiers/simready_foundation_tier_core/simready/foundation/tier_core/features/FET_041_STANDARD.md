...
`SemanticsLabelsAPI:cityscapes` instance are real members of the
**Cityscapes fine (35 classes)** taxonomy. It is a closed-vocabulary check:
...
- **[Open-Taxonomy-Cityscapes](../profiles/open-taxonomy-cityscapes.md)** (`v0.1.0`) - Validates one closed-vocabulary taxonomy at a time.
...
* Capability: [Dataset Taxonomies](../capabilities/dataset_taxonomies/capability-dataset_taxonomies.md)
    * Requirements:
        * [Cityscapes Labels](../capabilities/dataset_taxonomies/requirements/cityscapes-labels.md)
            * `CITY.001` | Version `0.1.0`
