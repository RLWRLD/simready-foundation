...
`SemanticsLabelsAPI:pascal_voc` instance are real members of the
**PASCAL VOC (20 classes)** taxonomy. It is a closed-vocabulary check: values
...
* Capability: [Dataset Taxonomies](../capabilities/dataset_taxonomies/capability-dataset_taxonomies.md)
    * Requirements:
        * [PASCAL VOC Labels](../capabilities/dataset_taxonomies/requirements/pascal-voc-labels.md)
            * `VOC.001` | Version `0.1.0`
