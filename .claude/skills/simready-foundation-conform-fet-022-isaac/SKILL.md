---
name: simready-foundation-conform-fet-022-isaac
description: "Use for repairing exact FET_022_ISAAC SimReady conformance for Isaac driven-joint conformance. Use when a profile, validation report, or user request names FET_022_ISAAC; default to version `0.2.0` unless a profile or report pins another version."
license: Apache-2.0
metadata:
...
- `nv_core/tiers/simready_foundation_tier_core/simready/foundation/tier_core/features/FET_022_ISAAC-0.1.0.json`
- `nv_core/tiers/simready_foundation_tier_core/simready/foundation/tier_core/features/FET_022_ISAAC-0.2.0.json`
...
|---|---|---|
| `0.1.0` | FET_022_PHYSX@0.1.0 | `DJ.008`, `DJ.009`, `DJ.010` |
| `0.2.0` | FET_022_PHYSX@0.2.0 | `DJ.008`, `DJ.009`, `DJ.010` |
...
2. Load the selected `FET_022_ISAAC` manifest and the feature markdown before editing.
...
5. Repair only the requirements listed by the selected `FET_022_ISAAC` manifest and its dependencies.
...
7. Summarize the selected `FET_022_ISAAC` version, changed files, validation evidence, and the first remaining blocker or next exact feature gate.

## Feature Guidance

- Repair only the requirements listed by the selected `FET_022_ISAAC` manifest and its dependencies.
...
| Field | Meaning |
|---|---|
| `feature` | Exact feature ID and version, for example `FET_022_ISAAC@0.2.0`. |
